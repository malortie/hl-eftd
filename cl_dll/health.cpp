...
int CHudHealth::DrawPain(float flTime)
{
	...
	if (m_fAttackFront > 0.4)
	{
		...
		m_fAttackFront = std::max( 0.0f, m_fAttackFront - fFade );
	} else
		m_fAttackFront = 0;
	...
	{
		GetPainColor(r,g,b);
		shade = a * static_cast<int>(std::max( m_fAttackRight, 0.5f ));
		ScaleColors(r, g, b, shade);
		SPR_Set(m_hSprite, r, g, b );
		...
		m_fAttackRight = std::max( 0.0f, m_fAttackRight - fFade );
	} else
		m_fAttackRight = 0;
	...
	{
		GetPainColor(r,g,b);
		shade = a * static_cast<int>(std::max( m_fAttackRear, 0.5f ));
		ScaleColors(r, g, b, shade);
		SPR_Set(m_hSprite, r, g, b );
		...
		m_fAttackRear = std::max( 0.0f, m_fAttackRear - fFade );
	} else
		m_fAttackRear = 0;
	...
	{
		GetPainColor(r,g,b);
		shade = a * static_cast<int>(std::max( m_fAttackLeft, 0.5f ));
		ScaleColors(r, g, b, shade);
		SPR_Set(m_hSprite, r, g, b );
		...
		m_fAttackLeft = std::max( 0.0f, m_fAttackLeft - fFade );
	} else
		m_fAttackLeft = 0;
